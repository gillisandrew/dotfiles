...
flowchart LR
    ...
    subgraph target ["Target (~/)"]
        ...
        T7[".local/bin/dotfiles-env<br/>.local/bin/dotfiles-motd-fast<br/>.local/bin/refresh-zorg-profiles<br/>...6 more scripts"]
        T8["(no files — side effects only)<br/>pre-commit install, symlink skills"]
    end
