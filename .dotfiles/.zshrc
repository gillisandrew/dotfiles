...
plugins=(git fast-syntax-highlighting zsh-nvm zsh-better-npm-completion node aws git-extras relay-helper gpg-agent-relay ssh-agent-relay docker-compose artisan)
else;
...
export PREFERRED_NODE_PACKAGE_MANAGER="npm"
